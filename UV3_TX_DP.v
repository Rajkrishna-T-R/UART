    ...
    always @(posedge clk or posedge RST)
        begin
            ...
            begin
                ...
                Tx_serial<=S_data_reg[0]; // Always LSB is the output 
                 
                if(load_data==1)
                    begin
                        S_data_reg<=data_in;  // Load the data
                    end 
                
                else if(shift_data==1)
                    begin
                        
                        S_data_reg<={1'b0,S_data_reg[7:1]}; // Shift logic
                ...
                if(rst_bit_count==1)
                    ...
                    begin
                        data_bit_count<=data_bit_count+1'b1; // Increment the count 
                    end
           end         
